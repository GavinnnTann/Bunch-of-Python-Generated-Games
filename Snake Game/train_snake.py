...
- Train original DQN agents (11 features)
...
Training Models:
- Original DQN: 11-feature state, basic training
...
from training_ui import main as run_training_ui
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("\nAvailable Models:")
    print("  • Original DQN - 11 features, basic training")
